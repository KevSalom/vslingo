...
- **Bugfix post-T10 (2026-07-27):** Voice Studio — etiquetas de burbuja fijas (`Tú` / `VSLingo`); ondas mic/VAD (gate suave `isSpeech`, reset al fin); ganancia visual del agente; PTT anima barras en vivo vía `AudioRecorder.onFrameLevel` (antes nivel fijo 0.55).
